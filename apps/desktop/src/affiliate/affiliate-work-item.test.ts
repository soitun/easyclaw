...
function createSampleReviewWorkItem(overrides: Partial<GQL.AffiliateWorkItem> = {}): GQL.AffiliateWorkItem {
  ...
  const sampleApplicationRecord: GQL.SampleApplicationRecord = {
    ...
    creatorId: "creator-001",
    productId: "product-001",
    status: GQL.SampleApplicationStatus.PendingReview,
    shipmentStatus: GQL.SampleShipmentStatus.Pending,
    contentFulfillmentStatus: null,
    platformApplicationStatus: null,
    platformContentFulfillmentStatus: null,
    platformFulfillmentId: null,
    carrier: null,
    trackingNumber: null,
    shippedAt: null,
    deliveredAt: null,
