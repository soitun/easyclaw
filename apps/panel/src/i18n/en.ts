export default {
  ...
  providers: {
    ...
    reauthModal: {
      ...
      tokenReady: "New OAuth token ready. Confirm to rotate the stored credential.",
      starting: "Starting…",
      rotating: "Rotating credential…",
      cancel: "Cancel",
      captureWarning: "Token rotated, but we couldn't read the subscription expiry. If your next request fails, please Re-authenticate again.",
    },
    modelLabel: "Model",
  ...
  ecommerce: {
    ...
    shopDrawer: {
      tabs: {
        ...
        affiliateManagement: "Affiliate Agent",
      },
      overview: {
        shopInfo: "Shop Information",
        tokenExpiry: "Token Expiry",
        csToggle: "AI Customer Service",
        inventoryToggle: "Warehouse Management",
