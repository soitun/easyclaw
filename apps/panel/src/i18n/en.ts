export default {
  ...
  mobile: {
    description: "Connect your mobile device to chat with your AI agent anywhere.",
    ...
    scanHint: "Open EasyClaw Mobile on your phone and scan the QR code to connect instantly.",
