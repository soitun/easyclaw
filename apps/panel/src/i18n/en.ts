export default {
  ...
  settings: {
    ...
    app: {
      ...
      accentColorHint: "Choose the accent color for the interface",
      accentBlue: "Blue",
      accentOrange: "Orange",
  ...
  tutorial: {
    ...
    chat: {
      ...
      toolsSelectorTitle: "Tools",
      toolsSelectorBody: "Click to open the tool selector. Here you can enable or disable specific tools (like web search, file access, etc.) for the current session. Disabled tools won't be available to the agent.",
    ...
    account: {
      ...
      welcomeBody: "The Account page shows your profile information and subscription status. Here you can view your plan, manage your account, and log out.",
      profileCardTitle: "Profile Card",
      profileCardBody: "Your account overview at a glance — showing your avatar, name, email, current plan, and when you joined. This card gives you a quick summary of your account identity.",
      ...
      logoutTitle: "Log Out",
      logoutBody: "Click this button to sign out of your account. You will be redirected to the home page. Features that require authentication (like Apps and Browser Profiles) will not be accessible until you log in again.",
      planTitle: "Current Plan",
      planBody: "Shows which subscription plan you are on (e.g., Free, Pro, Enterprise). Your plan determines the features and usage limits available to you.",
      ...
      subscriptionBody: "Detailed information about your active subscription. This section only appears if you have an active subscription. It shows plan details, payment status, seat usage, and expiration date.",
      subscriptionDetailsTitle: "Subscription Details",
      subscriptionDetailsBody: "Four key pieces of information: your plan name, subscription status (Active or Expired), seat usage (how many of your allocated seats are in use), and the date your subscription is valid until. Keep an eye on the expiration date to avoid service interruption.",
    },
  },
} as const;
