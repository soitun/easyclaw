export default {
  ...
  providers: {
    ...
    reauthModal: {
      ...
      completeSignIn: "完成登录",
      confirm: "确认更换凭据",
      tokenReady: "已获取新的 OAuth 令牌。点击确认以更换已存储的凭据。",
      starting: "启动中…",
      rotating: "正在更换凭据…",
      cancel: "取消",
      captureWarning: "凭据已更换，但订阅到期信息未能读取。如下次请求失败，请再次重新认证。",
    },
    modelLabel: "模型",
  ...
  ecommerce: {
    ...
    subtitle: "管理你的已连接店铺",
    shops: "店铺",
    shopsSubtitle: "已连接店铺与服务状态。",
    affiliateWorkspace: {
      title: "达人管理",
      subtitle: "集中审核 Agent 为达人生命周期生成的待执行动作。",
      allShops: "全部店铺",
      queueHint: "按达人和合作关系聚合，方便一次判断同一个达人相关的多个请求。",
      creatorGroupTitle: "达人 {{creatorId}}",
      unknownCreator: "未知达人",
      groupProposalCount: "{{count}} 个请求",
      proposalIdLabel: "提案",
      creatorIdLabel: "达人",
      collaborationIdLabel: "合作",
      copyFailed: "复制 ID 失败。",
    },
    addShop: "添加店铺",
    refreshShops: "刷新",
    ...
    shopDrawer: {
      tabs: {
        ...
        affiliateManagement: "达人 Agent",
      },
      overview: {
        shopInfo: "店铺信息",
        tokenExpiry: "令牌过期",
        csToggle: "AI 智能客服",
        inventoryToggle: "仓库管理",
      ...
      affiliate: {
        ...
        bindConflictTitle: "设备冲突",
        thisDevice: "本设备接管中",
        otherDevice: "由其他设备接管",
        runProfile: "Agent 权限配置",
        runProfileLabel: "运行配置",
        runProfileHint: "选择一个运行配置来控制达人 Agent 可以使用的工具。",
        runProfileNone: "未选择运行配置",
        businessPrompt: "达人业务提示词",
        businessPromptHint: "配置本店铺面向达人的合作规则、沟通风格、佣金/样品边界和人工复核要求。该提示词会注入达人管理 Agent run。",
        availableTools: "可用工具",
        toolCount: "共 {{count}} 个工具",
        proposals: "审批队列",
        pendingProposalCount: "{{count}} 个待审批提案",
        proposalsHint: "在执行前审核 Agent 冻结下来的动作。",
        refreshProposals: "刷新",
        noPendingProposals: "暂无待审批达人提案。",
        policyReasons: "策略",
        proposalApproveSuccess: "提案已同意并执行。",
        proposalRejectSuccess: "提案已拒绝。",
        proposalApprovedNote: "通过达人管理审批表同意。",
        proposalRejectedNote: "通过达人管理审批表拒绝。",
        messageIntentFallback: "{{type}} 消息",
        sampleReviewPreview: "{{decision}} 样品申请 {{applicationId}}",
        ...
        approvalPolicyPreview: "更新 {{action}} 的审批策略。",
        candidateDecisionPreview: "将 {{count}} 个候选达人标记为 {{status}}。",
        proposalTypes: {
          SEND_MESSAGE: "发送消息",
          APPROVE_SAMPLE: "同意样品",
          REJECT_SAMPLE: "拒绝样品",
          ...
          BLOCK_CREATOR: "拉黑达人",
          UPDATE_CAMPAIGN_PRODUCT: "推广商品",
          UPDATE_APPROVAL_POLICY: "审批策略",
          RECORD_CANDIDATE_DECISION: "候选决策",
        },
      },
    },
    inventory: {
      wmsAccounts: "仓库管理系统账号",
      wmsAccountsSubtitle: "从第三方仓库管理系统账号同步到后端的仓库。",
      ...
      noSyncedWarehouses: "此账号还没有同步到仓库。",
      warehouseName: "仓库",
      warehouseCode: "代码",
      warehouseType: "类型",
      region: "地区",
      ...
      warehouseTypes: {
        OFFICIAL_PLATFORM: "官方仓",
        THIRD_PARTY_WMS: "第三方仓库管理系统",
        SELLER_MANAGED: "卖家自管",
      },
      shopWarehouseTypes: {
        SALES: "销售仓",
      ...
      syncWarehouses: "同步仓库",
      inventoryGoods: "库存商品",
      inventoryGoodsSubtitle: "系统内部用于仓库与店铺库存流程的商品。",
      refreshInventoryGoods: "刷新库存商品",
      searchInventoryGoods: "搜索",
      searchInventoryGoodsPlaceholder: "搜索 SKU、条码、GTIN 或备注",
      applyInventoryGoodsFilters: "应用筛选",
      resetInventoryGoodsFilters: "重置",
      previousInventoryGoodsPage: "上一页",
      nextInventoryGoodsPage: "下一页",
      inventoryGoodsPage: "第 {{page}} 页",
      inventoryGoodsPageSummary: "共 {{count}} 个商品 · 第 {{page}} / {{pages}} 页",
      inventoryGoodsGoToPage: "跳到",
      inventoryGoodsGo: "跳转",
      addInventoryGood: "新增库存商品",
      editInventoryGood: "编辑库存商品",
      ...
      selectAllInventoryGoods: "选择全部库存商品",
      selectInventoryGood: "选择 {{sku}}",
      columns: "列",
      image: "图片",
      sku: "SKU",
      inventoryGoodColumn: "库存商品",
      identifiers: "标识",
      barcodeGtin: "条码 / GTIN",
      name: "名称",
      gtin: "GTIN",
      ...
      syncInventoryGoods: "同步库存商品",
      syncInventoryGoodsTitle: "同步库存商品",
      checkingInventoryGoodsCoverage: "正在检查库存商品匹配情况...",
      recognizedInventoryGoods: "已匹配",
      unrecognizedInventoryGoods: "待同步",
      viewDetails: "查看详情",
      ...
      unrecognizedInventoryGoodsList: "待新增的库存商品",
      moreUnrecognizedInventoryGoods: "还有 {{count}} 个商品",
      ...
      collapse: "收起",
      shopWarehouses: "店铺仓库",
      shopWarehousesHint: "将平台店铺仓库映射到后端 canonical warehouse 后，库存工作流才会使用。",
      syncShopWarehouses: "同步店铺仓库",
      noShopWarehouses: "后端还没有此店铺的仓库行。请先同步店铺仓库，让后端创建真实 row 后再映射。",
      shopWarehouseColumn: "店铺仓库",
      warehouseStatusColumn: "状态",
      canonicalWarehouseColumn: "Canonical warehouse",
      unmapped: "未映射",
      currentMapping: "当前映射",
      clearMapping: "清除",
      managedByPlatform: "平台已确定",
      officialWarehouseGroup: "官方仓",
      officialWarehouseGroupHint: "{{count}} 个平台已确定的店铺仓库",
      thirdPartyWarehouseTab: "三方仓库",
      officialWarehouseTab: "官方仓",
      noThirdPartyShopWarehouses: "没有需要映射的三方店铺仓库。",
      noOfficialShopWarehouses: "没有官方店铺仓库。",
      defaultWarehouse: "默认",
    },
